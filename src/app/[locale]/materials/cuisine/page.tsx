...
/* ========= Страница: Кухня (только видео) ========= */
export default function CuisinePage() {
  const t = useTranslations("cuisinePage");

  // Ссылки на видео (7 шт.)
  const links = [
    "https://www.youtube.com/watch?v=7SMUQqf6GnE",
    "https://www.youtube.com/watch?v=nyG3Obuvasg&list=PLr7v2RDvtpy93qQ--KZ1sxx-ZQs7g3ew3&index=6",
    "https://www.youtube.com/watch?v=4NvRfH9oBPQ&list=PLr7v2RDvtpy93qQ--KZ1sxx-ZQs7g3ew3&index=24",
    "https://www.youtube.com/watch?v=WWmuyN4Eti8&list=PLr7v2RDvtpy93qQ--KZ1sxx-ZQs7g3ew3&index=30",
    "https://www.youtube.com/watch?v=HDJxEj2zeR8&list=PLr7v2RDvtpy93qQ--KZ1sxx-ZQs7g3ew3&index=33",
    "https://www.youtube.com/watch?v=m9gvfmd-UvM&list=PLr7v2RDvtpy93qQ--KZ1sxx-ZQs7g3ew3&index=14",
    "https://www.youtube.com/watch?v=cjdF2ksuL-s&list=PLr7v2RDvtpy93qQ--KZ1sxx-ZQs7g3ew3&index=16"
  ];
  ...
  const videos = links.map((href, i) => {
    ...
    try {
      ...
      if (!id) {
        // Ссылка без параметров (например, только ?v=ID) уже обработана; если вдруг нет — пробуем последний сегмент
    ...
    <div className="min-h-screen w-full bg-white text-neutral-900 scroll-smooth dark:bg-neutral-950 dark:text-white">
      ...
      <section className="relative">
        <div className="mx-auto grid max-w-6xl items-start gap-8 px-4 py-10 md:grid-cols-[1.2fr_0.8fr]">
          ...
          {/* Кнопка: открыть плейлист (если задано в локали) */}
