...
export default function HistoryPage() {
  ...
  const playlistItems = links.map((href, i) => {
    ...
    return {
      ...
      title:
        t.optional?.(`videos.${i}.title`) ??
        `Видео #${i + 1} из плейлиста: История Казахстана`,
          ...
          >
            ...
            >
              {t.optional?.("videosSection.desc") ??
                "Подборка роликов по ключевым темам"}
            </motion.p>
      ...
      <section className="py-4 md:py-6">
        <div className="mx-auto max-w-6xl px-4">
          <SectionTitle
            ...
            title={
              t.optional?.("videosSection.title") ??
              "История Казахстана — видео"
            }
            desc={undefined}
          />
          <motion.div
