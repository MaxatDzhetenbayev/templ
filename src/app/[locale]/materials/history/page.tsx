...
/* ========= Страница: История (только видео) ========= */
export default function HistoryPage() {
  const t = useTranslations("historyPage");

  // 9 ссылок из заданного плейлиста
  const links = [
    "https://www.youtube.com/watch?v=Q-QZTyBxf54&list=PL3z5Sy3sFqP78H9A-lJcZyvngcygYHjlv&index=1",
    "https://www.youtube.com/watch?v=cfB-cFqUptA&list=PL3z5Sy3sFqP78H9A-lJcZyvngcygYHjlv&index=2",
    "https://www.youtube.com/watch?v=_gEGcYpOD74&list=PL3z5Sy3sFqP78H9A-lJcZyvngcygYHjlv&index=3",
    "https://www.youtube.com/watch?v=N-o1TaGoE70&list=PL3z5Sy3sFqP78H9A-lJcЗyvngcygYHjlv&index=4",
    "https://www.youtube.com/watch?v=J42pddtIa3U&list=PL3z5Sy3sFqP78H9A-lJcZyvngcygYHjlv&index=5",
    "https://www.youtube.com/watch?v=S9jEOT6Am8w&list=PL3z5Sy3sFqP78H9A-lJcZyvngcygYHjlv&index=6",
    "https://www.youtube.com/watch?v=mltR66rez8k&list=PL3z5Sy3sFqP78H9A-lJcZyvngcygYHjlv&index=7",
    "https://www.youtube.com/watch?v=da_jqVAd1fE&list=PL3z5Sy3sFqP78H9A-lJcZyvngcygYHjlv&index=9",
    "https://www.youtube.com/watch?v=Y1h8qFqIqwg&list=PL3z5Sy3sFqP78H9A-lJcZyvngcygYHjlv&index=10"
  ];
  ...
  const playlistItems = links.map((href, i) => {
    ...
    return {
      href,
      thumb,
      // тянем локализованные поля (если их нет — ставим дефолтные подписи)
      title: t.optional?.(`videos.${i}.title`) ?? `Видео #${i + 1} из плейлиста: История Казахстана`,
        ...
        <div className="mx-auto grid max-w-6xl items-start gap-8 px-4 py-10 md:grid-cols-[1.2fr_0.8fr]">
          <motion.div variants={container} initial="hidden" animate="show" className="space-y-5">
            ...
            <motion.p variants={item} className="text-neutral-700 dark:text-white/70">
              {t.optional?.("videosSection.desc") ?? "Подборка роликов по ключевым темам"}
            </motion.p>
          ...
          {/* Кнопка: открыть весь плейлист */}
          <a
            href="https://www.youtube.com/playlist?list=PL3z5Sy3sFqP78H9A-lJcZyvngcygYHjlv"
            target="_blank"
            rel="noopener noreferrer"
          ...
          >
            Открыть весь плейлист на YouTube
          </a>
        </div>
      </section>

      {/* Видео с YouTube — карточки-ссылки (только видео) */}
      <section className="py-4 md:py-6">
        <div className="mx-auto max-w-6xl px-4">
          <SectionTitle
            eyebrow={t.optional?.("videosSection.eyebrow") ?? "Видео"}
            title={t.optional?.("videosSection.title") ?? "История Казахстана — видео"}
            desc={undefined}
          />
          <motion.div
            variants={container}
