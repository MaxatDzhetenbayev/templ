...
/* ========= Страница: Язык (только видео, 10 ссылок) ========= */
export default function LanguagePage() {
  const t = useTranslations("languagePage");

  // 10 ссылок из плейлиста
  const links = [
    "https://www.youtube.com/watch?v=_HcG3vOIe1E&list=PLzjHT6KjLRg3Qg_dvuZN05FxBuwWqRqHe&index=1",
    "https://www.youtube.com/watch?v=efrRh4HptmY&list=PLzjHT6KjLRg3Qg_dvuZN05FxBuwWqRqHe&index=2",
    "https://www.youtube.com/watch?v=jBvnlISPovU&list=PLzjHT6KjLRg3Qg_dvuZN05FxBuwWqRqHe&index=3",
    "https://www.youtube.com/watch?v=iarTeKGwRrk&list=PLzjHT6KjLRg3Qg_dvuZN05FxBuwWqRqHe&index=4",
    "https://www.youtube.com/watch?v=4bFtc1FVvso&list=PLzjHT6KjLRg3Qg_dvuZN05FxBuwWqRqHe&index=5",
    "https://www.youtube.com/watch?v=synbpls4fEA&list=PLzjHT6KjLRg3Qg_dvuZN05FxBuwWqRqHe&index=6",
    "https://www.youtube.com/watch?v=SjTaMBuOBzY&list=PLzjHT6KjLRg3Qg_dvuZN05FxBuwWqRqHe&index=7",
    "https://www.youtube.com/watch?v=xNNbGYCQwrE&list=PLzjHT6KjLRg3Qg_dvuZN05FxBuwWqRqHe&index=8",
    "https://www.youtube.com/watch?v=0q2X61Ebr2w&list=PLzjHT6KjLRg3Qg_dvuZN05FxBuwWqRqHe&index=9",
    "https://www.youtube.com/watch?v=kFUkbYz_ox4&list=PLzjHT6KjLRg3Qg_dvuZN05FxBuwWqRqHe&index=10"
  ];

  const videos = links.map((href, i) => {
    let id = "";
    try {
    ...
    return {
      href,
      thumb,
      title: (t.optional?.(`videos.${i}.title`) as string | undefined) ?? (t.optional?.("fallbackTitle") as string | undefined) ?? `Видео #${i + 1}`,
    ...
    <div className="min-h-screen w-full bg-white text-neutral-900 scroll-smooth dark:bg-neutral-950 dark:text-white">
      ...
      <section className="relative">
        <div className="mx-auto grid max-w-6xl items-start gap-8 px-4 py-10 md:grid-cols-[1.2fr_0.8fr]">
          ...
          <a
            href="https://www.youtube.com/playlist?list=PLzjHT6KjLRg3Qg_dvuZN05FxBuwWqRqHe"
            target="_blank"
            rel="noopener noreferrer"
          ...
          >
            {t.optional?.("openPlaylist") ?? "Открыть весь плейлист на YouTube"}
          </a>
        </div>
      </section>
